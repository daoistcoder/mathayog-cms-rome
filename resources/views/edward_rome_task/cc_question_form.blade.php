...
<body>
    ...
    <div class="form-container">
        <form action="">
            ...
            <label for="course_module">Select Course Module:</label>
            ...
            <button name="add_activity">Add question</button>
            <br><br>
    ...
    <script type="text/javascript" src="{{URL::asset('../../js/cc_question.js')}}"></script>
</body>
</html>
