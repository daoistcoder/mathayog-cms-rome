...
const courseContent2 = document.getElementById('course_content_2');

selectCourse.addEventListener('change', (e) => {
    e.preventDefault();
    if (selectCourse[selectCourse.selectedIndex].value === 'WN-P2-A1'){
        courseTitle.innerText = selectCourse[selectCourse.selectedIndex].text;
        courseContent.style.display = 'block';
        courseContent2.style.display = 'none';
    } else{
        courseTitle.innerText = selectCourse[selectCourse.selectedIndex].text;
        courseContent2.style.display = 'block';
